...
//    private static final String STATIC_WEATHER_URL =  "http://api.openweathermap.org/data/2.5/forecast/daily";
    ...
    private static final String key = ""; // api key  of open weather map api
